...
class UpYunApiException extends Exception {/*{{{*/
...
class UpYunApiAuthorizationException extends UpYunApiException {/*{{{*/
    public function __construct($message, $code = 0, Exception $previous = null) {
        parent::__construct($message, 401, $previous);
    }
}/*}}}*/

class UpYunApiForbiddenException extends UpYunApiException {/*{{{*/
    public function __construct($message, $code = 0, Exception $previous = null) {
        parent::__construct($message, 403, $previous);
    }
}/*}}}*/

class UpYunApiNotFoundException extends UpYunApiException {/*{{{*/
    public function __construct($message, $code = 0, Exception $previous = null) {
        parent::__construct($message, 404, $previous);
    }
}/*}}}*/

class UpYunApiNotAcceptableException extends UpYunApiException {/*{{{*/
    public function __construct($message, $code = 0, Exception $previous = null) {
        parent::__construct($message, 406, $previous);
    }
}/*}}}*/

class UpYunApiServiceUnavailable extends UpYunApiException {/*{{{*/
    public function __construct($message, $code = 0, Exception $previous = null) {
...
/*}}}*/
	...
	*/
    ...
    protected function _do_request($method, $path, $headers = NULL, $body= NULL, $file_handle= NULL) {/*{{{*/
        ...
        if ($http_code == 0) throw new UpYunApiException('Connection Failed', $http_code);
        ...
        if ($http_code == 200) {
            ...
            switch($http_code) {
                case 401:
                    throw new UpYunApiAuthorizationException($message);
                    break;
                case 403:
                    throw new UpYunApiForbiddenException($message);
                    break;
                case 404:
                    throw new UpYunApiNotFoundException($message);
                    break;
                case 406:
                    throw new UpYunApiNotAcceptableException($message);
                    break;
                case 503:
                    throw new UpYunApiServiceUnavailable($message);
                    break;
                default:
                    throw new UpYunApiException($message, $http_code);
            }
        }
    }/*}}}*/
