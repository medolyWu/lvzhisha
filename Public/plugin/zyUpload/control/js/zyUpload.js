		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
                    ...
                    html += '               <div class="filePicker" style="width:80px;float: left; height:34px;line-height: 34px;text-align: center; font-size: 16px;margin-right: 7px;margin-top: 6px;">点击选择文件</div>';
			...
			this.createCorePlug = function(){
				var params = {
					...
					onDelete: function(file, files) {
						// 移除效果
						$("#uploadList_" + file.index).fadeOut(900,'swing',function(){
					...
					onSuccess: function(file, response) {
                        ...
                        if(jsonobj.error){
                            ...
                            uploadback(file.index,jsonobj.url);
                        }else{
