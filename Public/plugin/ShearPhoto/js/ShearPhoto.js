...
ShearPhoto.prototype = {
          ...
          complete:function(serverdata) {//截图完成，shearphoto.php返回数据过来
                   ...
                   /* var length = serverdata.length;
                    ...
                    complete.innerHTML = AllImgSrc + '<div class="completeTxt"><strong><i></i>'+ serverdata.success +'</strong><a href="'+ serverdata.url +'" id="completeA">完成</a></div>';
          ...
          SendPHP:function(postArgs) {//发送坐标数据给PHP
                    ...
                    var SendArry = {};
                    SendArry.url = UPYUN_URL + this.ImgUrl;
                    var R = {
                              1:90,
                              2:180,
                              3:270,
